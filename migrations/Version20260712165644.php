...
final class Version20260712165644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE kpy_product (id_product INT UNSIGNED NOT NULL, id_product_attribute INT UNSIGNED NOT NULL, is_jirafa TINYINT DEFAULT 0 NOT NULL, is_pack TINYINT DEFAULT 0 NOT NULL, weight DOUBLE PRECISION DEFAULT 0 NOT NULL, brand_id SMALLINT UNSIGNED NOT NULL, sales_price_es NUMERIC(6, 2) NOT NULL, PRIMARY KEY (id_product, id_product_attribute)) DEFAULT CHARACTER SET utf8mb4');
