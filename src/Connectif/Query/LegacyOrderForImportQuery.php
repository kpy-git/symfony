...
class LegacyOrderForImportQuery implements ConnectifQueryInterface
{
    ...
    {
        return 'kpy.connectif.query.legacy_order_for_import';
    }
    ...
    public function fetch(array $params = []): array
    {
        ...
        if (!isset($params['id_order'])) {
            throw new ConnectifException('Es necesario el id_order para obtener los resultados');
        }
        ...
        $sql = "SELECT o.id_order,
                ...
                WHERE o.module != 'free_order'
                    and o.id_order = {$params['id_order']}
                    and o.total_paid > 0
                    and o.id_customer > 5
        ...
        return $this->pymDatabase->getRow($sql);
    }
}
