...
class GoogleMerchantFeedHandler
{
    ...
    public function generateFeed(Shop $shop): string
    {
        ...
        foreach ($productos as $producto) {
            ...
            $availability = $producto['stock'] > 0 || in_array($producto['id_manufacturer'], [3, 77, 78, 75, 93, 173, 121, 203, 4, 48, 49, 13, 199, 25, 58, 92, 62, 27, 1, 13, 48, 49, 25, 58, 92, 62, 116, 175, 174, 173, 93, 205, 222,]) ? 'in stock' : 'out of stock';
